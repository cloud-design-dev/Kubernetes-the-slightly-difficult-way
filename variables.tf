...
variable "controller_rules" {
  description = "A list of security group rules to be added to the controller security group"
  type = list(
    object({
      name      = string
      direction = string
...
variable "worker_rules" {
  description = "A list of security group rules to be added to the worker security group"
  type = list(
    object({
      name      = string
      direction = string
